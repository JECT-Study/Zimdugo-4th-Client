...
describe("formatUpdatedLabel", () => {
  ...
  it("1시간 이상 1일 미만은 시간 단위 상대 시간을 표시한다", () => {
    ...
    expect(formatUpdatedLabel("2026-06-07T10:00:00.000Z", NOW)).toBe(
      "2시간 전 업데이트",
    );
  });
  ...
  it("1일 이상 30일 미만은 일 단위 상대 시간을 표시한다", () => {
    ...
    expect(formatUpdatedLabel("2026-06-01T12:00:00.000Z", NOW)).toBe(
      "6일 전 업데이트",
    );
    expect(formatUpdatedLabel("2026-05-09T12:00:00.000Z", NOW)).toBe(
      "29일 전 업데이트",
    );
  });
  ...
  it("30일 이상 365일 미만은 개월 단위 상대 시간을 표시한다", () => {
    ...
    expect(formatUpdatedLabel("2026-05-08T12:00:00.000Z", NOW)).toBe(
      "1개월 전 업데이트",
    );
    expect(formatUpdatedLabel("2025-07-07T12:00:00.000Z", NOW)).toBe(
      "11개월 전 업데이트",
    );
  });
  ...
  it("365일 이상은 년 단위 상대 시간을 표시한다", () => {
    ...
    expect(formatUpdatedLabel("2025-06-07T12:00:00.000Z", NOW)).toBe(
      "1년 전 업데이트",
    );
    expect(formatUpdatedLabel("2024-06-07T12:00:00.000Z", NOW)).toBe(
      "2년 전 업데이트",
    );
  });
